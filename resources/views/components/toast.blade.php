...
@php
    ...
    $type = $type ?: 'success';
    $color = $config[$type] ?? $config['success'];
@endphp

<div id="toast-{{ $type }}" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow-sm dark:text-gray-400 dark:bg-gray-800" role="alert">
    <div class="inline-flex items-center justify-center shrink-0 w-8 h-8 {{ $color['icon'] }} rounded-lg">
